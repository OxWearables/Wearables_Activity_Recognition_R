...
dir_cap24 <- paste0(here(), 'data/capture24sample', sep = '/')
zip_cap24 <- paste0(here(), 'data/capture24sample.zip', sep = '/')
```
...
This has been uploaded to a google drive, and can be downloaded with the code below.
...
Let's load and inspect the raw data for one that participant (p001):
